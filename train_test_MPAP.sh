...
do
   ...
   python MPAPNet.py --dataset $a --fold $i --tag $tag --batch_size 64 --accumulation_steps 2 --test_batch_size 8 --epochs 200 --labelsmoothing --a 0.5 --b 0.3 --c 0.2 --backbone resnet50 --lr 0.01
done
